...
class Client {
  constructor(config) {
    ...
    this.defaultMaxRetry = this.httpOptions.maxRetry === undefined ? 3 : this.httpOptions.maxRetry;
    this.defaultTimout = this.httpOptions.timeout === undefined ? 6000 : this.httpOptions.timeout;
