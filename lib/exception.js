...
function serverException(name, text, errOpts) {
    return throwException(name || "Server Error", text, errOpts);
}

function clientException(name, text, errOpts) {
    return throwException(name || "Client Error", text, errOpts);
}
